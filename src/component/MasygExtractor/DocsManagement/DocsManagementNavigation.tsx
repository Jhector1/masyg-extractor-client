...
const DocsManagementNavigation = ({ openModal, open = 'hidden' }: MainSidebarProps) => {
  return (
 
      <div
        className={`${open} md:flex absolute right-0 md:sticky border-t border-gray-200  justify-center top-0 flex-col h-screen w-128 bg-white shadow-md`}>
        {/* Logo */}
